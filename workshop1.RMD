...
grepl("Breast", studies$name, ignore.case = T )[1:3]
...
datatable ( t ( myclinicaldata[myclinicaldata$pid %in% myid, ] ))
...
datatable ( head ( mutations [ , c( cleanmut )]) )
...
datatable ( head ( action[ ,action.f], 10)  )
...
datatable ( head ( action[action$clinical_significance == "Sensitivity/Response" ,action.f], 10) )
